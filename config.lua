mod_config = {
	...
	-- move_lobby_to_spawn = false, -- false -> the lobby location will be relative to the mouse controlls stone; true -> the lobby location will be on the spawn location
