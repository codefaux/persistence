...
if initialized==false then
  ...
  function get_action_metadata( action_id )
    ...
    Reflection_RegisterProjectile = function( projectile_xml )
      ...
      --   EntityApplyTransform( projectile_entity, -20000, -20000 );
      ...
      --     for k,v in pairs( ComponentGetMembers( projectile ) ) do
      ...
      --         metadata.projectiles[filepath]["damage_"..type] = ComponentObjectGetValue2( projectile, "damage_by_type", type ) or 0;
      --       end
      --     end

      --     local config_explosion = ComponentObjectGetMembers( projectile, "config_explosion" );
      --     if config_explosion then
      --       metadata.projectiles[filepath].damage_explosion = ComponentObjectGetValue2( projectile, "config_explosion", "damage" );
      --     end
      --   end
